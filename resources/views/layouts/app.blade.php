...
<head>
    ...
    <style type="text/tailwindcss">
        @media (max-width: 800px) {
            ...
            .container {
                @apply mx-4 ml-10 mb-10 text-center; /* Adjust the margin for smaller screens */
            }

            .text-xl {
                @apply text-2xl; /* Increase the font size for extra-large text */
            }

            .btn {
                @apply text-base px-3 py-2; /* Increase button padding and adjust font size */
            }

            label {
                @apply mb-1 text-base; /* Adjust margin and font size for labels */
            }

            input,
            textarea {
                @apply py-2 px-3 text-base; /* Adjust padding and font size for inputs */
            }

            .error {
                @apply text-red-500 text-sm; /* Adjust font size for error messages */
            }
        }
...
<div class="antialiased bg-black w-full min-h-screen text-slate-300 relative py-4">
    <div class="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4 ">
            <h1 class="font-bold text-lg lg:text-3xl bg-gradient-to-br from-white via-white/50 to-transparent bg-clip-text text-transparent">Tasks Home<span class="text-indigo-400">.</span></h1>
            ...
            <a href="#" class="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                ...
                <div>
                    <p class="font-medium group-hover:text-indigo-400 leading-4">User Unknown</p>
                    <span class="text-xs text-slate-400">Tasks LLC</span>
                </div>
            </a>
        ...
        <!-- The View Logic  -->
        <div class="bg-white/10 col-span-9 rounded-lg p-6 mb-10">
            <h1 class="text-xl md:text-2xl mb-4">@yield('title')</h1>
            ...
            <div>
                <div x-data="{ flash: true }">
                    ...
                    <div x-show="flash"
                        class="relative mb-10 rounded border border-green-400 bg-green-100 px-4 py-3 text-lg md:text-base text-green-700"
                        role="alert">
        ...
        <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6 mt-10">
            <div id="24h">
